  ...
  actions: {
    login({ commit }, usuario) {
      return new Promise((resolve, reject) => {
        commit("auth_request");
        axios
          .post(baseUrl + "/usuarios/login", usuario)
          .then(response => {
    ...
    register({ commit }, usuario) {
      return new Promise((resolve, reject) => {
        commit("auth_request");
        axios
          .post(baseUrl + "/usuarios/register", usuario)
          .then(response => {
    ...
    getCoordinadores({ commit }) {
      return new Promise((resolve, reject) => {
        axios
          .get(baseUrl + "/usuarios/coordinadores")
          .then(response => {
    ...
    getActividadesCat({ commit }) {
      return new Promise((resolve, reject) => {
        axios
          .get(baseUrl + "/actividades/categorias")
          .then(response => {
    ...
    crearActividad({ commit }, usuario) {
      return new Promise((resolve, reject) => {
        axios
          .post(baseUrl + "/actividades/crear", usuario, {
